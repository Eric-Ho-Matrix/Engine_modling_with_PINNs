...
# # c_omega_psi_1        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
# # c_omega_psi_2        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
# # c_omega_psi_3        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
# # c_omega_phi_1        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
# # c_omega_phi_2        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
# # c_omega_phi_3        = torch.nn.Parameter(torch.tensor([1e-1])).detach().to(device).requires_grad_(True)
...
#     A_egrmax_pred_phy = relu(A_egrmax_train)*1e-4
#     p_im_pred_phy = (relu(p_im_pred)+1.85)*1e5
#     p_em_pred_phy = (relu(p_em_pred)+2.1)*1e5


#     omega_t_pred = omega_t_nn(t_tensor).reshape(-1,1)
#     # transfer to phy domain
#     omega_t_pred_phy = (relu(omega_t_pred)+7.3)* 1e3
#     # c_omega_psi_1_pred_phy = c_omega_psi_1_pred * 1e-7
#     # c_omega_psi_2_pred_phy = c_omega_psi_2_pred * 1e-3
#     # c_omega_psi_3_pred_phy = c_omega_psi_3_pred * 1
...
#     T_1_pred_phy = (relu(T_1_pred)+314.5/300) * 300
#     x_r_pred_phy = (relu(x_r_pred)+1)*0.03
    
#     # used for calculate pim physics loss
#     W_c_physics = Compressor_ins.comp_mass_flow(p_im_pred_phy, omega_t_pred_phy, 
#                                             c_wpsiVec_tensor[0], c_wpsiVec_tensor[1], c_wpsiVec_tensor[2], 
#                                             c_wphiVec_tensor[0], c_wphiVec_tensor[1], c_wphiVec_tensor[2])
...
#     loss3  = weighted_loss(1                   , p_im_physics_loss(p_im_pred_phy, t_tensor, R_a, T_im, V_im, W_c_physics, W_egr_physics, W_ei_physics) )
#     loss4  = weighted_loss(1                   , p_em_physics_loss(p_em_pred_phy, t_tensor, R_e, T_em_physics, V_em, W_eo_physics, W_egr_physics, W_t_physics)) 
#     loss5  = weighted_loss(1                   , omega_t_physics_loss(omega_t_pred_phy, t_tensor, Pt_eta_m_physics, p_c_physics, J_t))
#     loss6  = weighted_loss(1                   , u_egr1_physics_loss(uegr_1_bar_pred_phy, t_tensor, tau_egr1, u_egr, tau_degr))
#     loss7  = weighted_loss(1                   , u_egr2_physics_loss(uegr_2_bar_pred_phy, t_tensor, tau_egr2, u_egr, tau_degr))
#     loss8  = weighted_loss(1                   , u_vgt_bar_physics_loss(u_vgt_bar_pred_phy, t_tensor, tau_vgt, u_vgt, tau_dvgt))
#     loss9  = weighted_loss(1000                , T_1_physics_loss(T_1_pred_phy, x_r_pred_phy, T_e_physics, T_im))
#     loss10 = weighted_loss(1                   , x_r_physics_loss(x_r_pred_phy, p_im_pred_phy, p_em_pred_phy, gamma_a, x_p_physics, r_c, x_v_physics))
#     loss11 = weighted_loss(1                   , (p_im_pred_phy[0] - p_im_Init))
#     loss12 = weighted_loss(1                   , (p_em_pred_phy[0] - p_em_Init))
#     loss13 = weighted_loss(1                   , (omega_t_pred_phy[0] - omega_t_Init)) 
#     loss14 = weighted_loss(1                   , (uegr_1_bar_pred_phy[0] - uegr_1_bar_Init)) 
#     loss15 = weighted_loss(1                   , (uegr_2_bar_pred_phy[0] - uegr_2_bar_Init))
#     loss16 = weighted_loss(1                   , (u_vgt_bar_pred_phy[0] - u_vgt_bar_Init)) 
#     loss17 = weighted_loss(10                  , (x_r_pred_phy[0] - x_r_Init)) 
#     loss18 = weighted_loss(100                 , (T_1_pred_phy[0] - T_1_Init))
...
#         plt.show()
#     else:
#         plt.savefig("pic_task1/Loss{}.png".format(i+1))
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/Total_Loss.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/Lambda1.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/Lambda2.png")
#     plt.close()
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/A_EGRMAX_Pred.png")
#     plt.close()

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PSI_1)
# # plt.title("C_OMEGA_PSI_1 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PSI_1_Pred.png")

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PSI_2)
# # plt.title("C_OMEGA_PSI_2 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PSI_2_Pred.png")

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PSI_3)
# # plt.title("C_OMEGA_PSI_3 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PSI_3_Pred.png")

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PHI_1)
# # plt.title("C_OMEGA_PHI_1 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PHI_1_Pred.png")

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PHI_2)
# # plt.title("C_OMEGA_PHI_2 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PHI_2_Pred.png")

# # plt.figure()
# # plt.plot(xx, C_OMEGA_PHI_3)
# # plt.title("C_OMEGA_PHI_3 Prediction")
# # if save_flag == None:
# #     plt.show()
# # else:
# #     plt.savefig("pic_task1/C_OMEGA_PHI_3_Pred.png")


# ## save model
# torch.save(pim_pem_nn.state_dict() , 'model_task1/pim_pem_nn.pth')
# torch.save(omega_t_nn.state_dict() , 'model_task1/omega_t_nn.pth')
# torch.save(uegr_1_2_nn.state_dict(), 'model_task1/uegr_1_2_nn.pth')
# torch.save(u_vgt_nn.state_dict()   , 'model_task1/u_vgt_nn.pth')
# torch.save(T_1_nn.state_dict()     , 'model_task1/T_1_nn.pth')
# torch.save(x_r_nn.state_dict()     , 'model_task1/x_r_nn.pth')
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/p_im.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/p_em.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/u_egr_bar_1.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/u_egr_bar_2.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/u_vgt_bar.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/omega_t.png")
...
#     plt.show()
# else:
#     plt.savefig("pic_task1/x_r.png")

# print(A_egrmax_pred_phy)
...
#     p_im_pred_phy = (softplus(p_im_pred)+1.85)*1e5
#     p_em_pred_phy = (softplus(p_em_pred)+2.1)*1e5


#     omega_t_pred = omega_t_nn(t_tensor).reshape(-1,1)
#     # transfer to phy domain
#     omega_t_pred_phy = (softplus(omega_t_pred))* 5e3
#     # c_omega_psi_1_pred_phy = c_omega_psi_1_pred * 1e-7
#     # c_omega_psi_2_pred_phy = c_omega_psi_2_pred * 1e-3
#     # c_omega_psi_3_pred_phy = c_omega_psi_3_pred * 1
#     # c_omega_phi_1_pred_phy = c_omega_phi_1_pred * 1e-7
...
#     # transfer to phy domain
#     u_vgt_bar_pred_phy = sigmoid(u_vgt_bar_pred) * 100
#     T_1_pred_phy = (softplus(T_1_pred)+314.5/300) * 300
#     x_r_pred_phy = (softplus(x_r_pred)+1)*0.03
...
# adaptive weights for loss term
lambda_p_im_data     = torch.nn.Parameter(torch.full((t_tensor.shape[0],1), 1000.0,device=device),requires_grad=True)
lambda_p_em_data     = torch.nn.Parameter(torch.full((t_tensor.shape[0],1), 100.0,device=device),requires_grad=True)
...
A_egrmax_train       = torch.nn.Parameter(torch.tensor([3.5],device=device),requires_grad=True)
# c_omega_psi_1_train  = torch.nn.Parameter(torch.tensor([1.0],device=device),requires_grad=True)
# c_omega_psi_2_train  = torch.nn.Parameter(torch.tensor([1.0],device=device),requires_grad=True)
# c_omega_psi_3_train  = torch.nn.Parameter(torch.tensor([1.0],device=device),requires_grad=True)
# c_omega_phi_1_train  = torch.nn.Parameter(torch.tensor([1.0],device=device),requires_grad=True)
# c_omega_phi_2_train  = torch.nn.Parameter(torch.tensor([1.0],device=device),requires_grad=True)
# c_omega_phi_3_train  = torch.nn.Parameter(torch.tensor([2.5],device=device),requires_grad=True)
...
for epoch in range(Epoch):
    ...
    # used for calculate pim physics loss
    W_c_physics = Compressor_ins.comp_mass_flow(p_im_pred_phy, omega_t_pred_phy, 
                                            c_wpsiVec[0], c_wpsiVec[1], c_wpsiVec[2], 
                                            c_wphiVec[0], c_wphiVec[1], c_wphiVec[2])
    ...
    loss3  = weighted_loss(1                   , p_im_physics_loss(p_im_pred_phy, t_tensor, R_a, T_im, V_im, W_c_physics, W_egr_physics, W_ei_physics) )
    loss4  = weighted_loss(1                   , p_em_physics_loss(p_em_pred_phy, t_tensor, R_e, T_em_physics, V_em, W_eo_physics, W_egr_physics, W_t_physics)) 
    loss5  = weighted_loss(10                  , omega_t_physics_loss(omega_t_pred_phy, t_tensor, Pt_eta_m_physics, p_c_physics, J_t))
    loss6  = weighted_loss(1                   , u_egr1_physics_loss(uegr_1_bar_pred_phy, t_tensor, tau_egr1, u_egr, tau_degr))
    loss7  = weighted_loss(1                   , u_egr2_physics_loss(uegr_2_bar_pred_phy, t_tensor, tau_egr2, u_egr, tau_degr))
    loss8  = weighted_loss(1                   , u_vgt_bar_physics_loss(u_vgt_bar_pred_phy, t_tensor, tau_vgt, u_vgt, tau_dvgt))
    loss9  = weighted_loss(100                 , T_1_physics_loss(T_1_pred_phy, x_r_pred_phy, T_e_physics, T_im))
    loss10 = weighted_loss(10                  , x_r_physics_loss(x_r_pred_phy, p_im_pred_phy, p_em_pred_phy, gamma_a, x_p_physics, r_c, x_v_physics))
    loss11 = weighted_loss(1                   , (p_im_pred_phy[0] - p_im_Init))
    loss12 = weighted_loss(1                   , (p_em_pred_phy[0] - p_em_Init))
    loss13 = weighted_loss(1                   , (omega_t_pred_phy[0] - omega_t_Init)) 
    loss14 = weighted_loss(1                   , (uegr_1_bar_pred_phy[0] - uegr_1_bar_Init)) 
    loss15 = weighted_loss(1                   , (uegr_2_bar_pred_phy[0] - uegr_2_bar_Init))
    loss16 = weighted_loss(1                   , (u_vgt_bar_pred_phy[0] - u_vgt_bar_Init)) 
    loss17 = weighted_loss(1                   , (x_r_pred_phy[0] - x_r_Init)) 
    loss18 = weighted_loss(100                 , (T_1_pred_phy[0] - T_1_Init))
    ...
    if epoch < epoch_for_adp_weights:  # train lambda
        ...
        for param in optimizer_adp_weights.param_groups:
