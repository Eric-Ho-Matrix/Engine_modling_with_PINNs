...
W_egr_gt  = workspace_sim['simW_egr']
...
W_egr_gt_tensor  = torch.from_numpy(W_egr_gt).float().to(device)
...
# add noises 2%
p_im_tensor += torch.randn(p_im_tensor.shape) * (torch.std(p_im_tensor) * (5 / 100))
p_em_tensor += torch.randn(p_em_tensor.shape) * (torch.std(p_em_tensor) * (5 / 100))
W_egr_gt_tensor += torch.randn(W_egr_gt_tensor.shape) * (torch.std(W_egr_gt_tensor) * (5 / 100))
omega_t_gt += torch.randn(omega_t_gt.shape) * (torch.std(omega_t_gt) * (5 / 100))
...
lambda_w_egr_data    = torch.nn.Parameter(torch.full((t_tensor.shape[0],1), 1000.0)).detach().to(device).requires_grad_(True)
...
for epoch in range(Epoch):
    ...
    loss4  = weighted_loss(lambda_omega_t_data , (W_egr_physics - W_egr_gt_tensor))
    ...
    loss12 = weighted_loss(1                   , x_r_physics_loss(x_r_pred_phy, p_im_pred_phy, p_em_pred_phy, gamma_a, x_p_physics, r_c, x_v_physics))
    ...
    loss19 = weighted_loss(10                  , (x_r_pred_phy[0] - x_r_Init)) 
    ...
    LOSS20.append(loss20.detach().cpu().numpy())
...
LOSSES = [LOSS1, LOSS2, LOSS3, LOSS4, LOSS5, LOSS6, LOSS7, LOSS8, LOSS9, LOSS10,
          LOSS11, LOSS12, LOSS13, LOSS14, LOSS15, LOSS16, LOSS17, LOSS18, LOSS19,LOSS20]
# loss plot
...
for i in range(20):
    ...
    if save_flag == None:
        ...
        plt.savefig("pic_task3/Loss{}.png".format(i+1))
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/Total_Loss.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/Lambda1.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/Lambda2.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/WATCH.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/A_EGRMAX_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PSI_1_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PSI_2_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PSI_3_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PHI_1_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PHI_2_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/C_OMEGA_PHI_3_Pred.png")


## save model
torch.save(pim_pem_nn.state_dict() , 'model_task3/pim_pem_nn.pth')
torch.save(omega_t_nn.state_dict() , 'model_task3/omega_t_nn.pth')
torch.save(uegr_1_2_nn.state_dict(), 'model_task3/uegr_1_2_nn.pth')
torch.save(u_vgt_nn.state_dict()   , 'model_task3/u_vgt_nn.pth')
torch.save(T_1_nn.state_dict()     , 'model_task3/T_1_nn.pth')
torch.save(x_r_nn.state_dict()     , 'model_task3/x_r_nn.pth')
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/p_im.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/p_em.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/u_egr_bar_1.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/u_egr_bar_2.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/u_vgt_bar.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/omega_t.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task3/x_r.png")


W_egr_gt_tensor_norm = normalize(W_egr_gt_tensor)
W_egr_physics_norm   = normalize(W_egr_physics)
plt.figure()
plt.plot(t_tensor.detach().cpu().numpy(), W_egr_physics_norm.detach().cpu().numpy(), label="pred")
plt.plot(t_tensor.detach().cpu().numpy(), W_egr_gt_tensor_norm.detach().cpu().numpy(), '--',label="GT")
plt.title("w_egr")
plt.legend()
if save_flag == None:
    plt.show()
else:
    plt.savefig("pic_task3/w_egr.png")
