...
num_neurons = 128
output_dim = 1
PHI_C_nn = PINN(input_dim, hidden_layers, num_neurons, output_dim).to(device)
PHI_C_nn.load_state_dict(torch.load('model_task4/PHI_C.pth'))

# Use the loaded model for inference or further training
PHI_C = PHI_C_nn(t_tensor)
...
for epoch in range(Epoch):
    ...
    W_c_physics = Compressor_ins.comp_mass_flow_pre_tra_nn( omega_t_pred_phy, PHI_C)
...
for i in range(18):
    ...
    if save_flag == None:
        ...
        plt.savefig("model_task4/Loss{}.png".format(i+1))
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/Lambda1.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/Lambda2.png")
    plt.close()
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/Lambda3.png")
    plt.close()
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/LAMBDA4.png")
    plt.close()
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/A_EGRMAX_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PSI_1_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PSI_2_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PSI_3_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PHI_1_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PHI_2_Pred.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/C_OMEGA_PHI_3_Pred.png")


## save model
torch.save(pim_pem_nn.state_dict() , 'model_task4/pim_pem_nn.pth')
torch.save(omega_t_nn.state_dict() , 'model_task4/omega_t_nn.pth')
torch.save(uegr_1_2_nn.state_dict(), 'model_task4/uegr_1_2_nn.pth')
torch.save(u_vgt_nn.state_dict()   , 'model_task4/u_vgt_nn.pth')
torch.save(T_1_nn.state_dict()     , 'model_task4/T_1_nn.pth')
torch.save(x_r_nn.state_dict()     , 'model_task4/x_r_nn.pth')
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/p_im.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/p_em.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/u_egr_bar_1.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/u_egr_bar_2.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/u_vgt_bar.png")
...
if save_flag == None:
    ...
    plt.savefig("pic_task4/omega_t.png")
...
if save_flag == None:
    ...
    plt.savefig("model_task4/x_r.png")
